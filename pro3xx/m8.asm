...
2$:
	...
	mov #^B0000000000000000,8(r1)  ;plane 2 & 3, the NOP-op
    mov r2,20(r1)
    mov @#YCU,16(r1)
    mov @#XC,14(r1)
    mov #1,18(r1)
    ...
    mov #^B0000000000000000,6(r1) ;plane 1, the NOP-op
    mov #^B0000000000000010,8(r1) ;plane 2 & 3, the MOV/NOP-op
    mov r2,20(r1)
    mov #1,18(r1)
    tst (r0)   ;transfer done?
    bpl .-2
    ...
    mov #^B0000001000000000,8(r1) ;plane 2 & 3, the NOP/MOV-op
    mov r2,20(r1)
    mov #1,18(r1)
    tst (r0)   ;transfer done?
    bpl .-2
