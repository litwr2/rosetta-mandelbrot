...
2$:
.if ne VIDEO
	bic	#^B1111111111111000,r2	; get 3 bits of color, $fff8
.endc
	mov #1,r0
	xor r0,@#xtoggle
	beq 8$
.if ne VIDEO
patt2 = .+2
    movb pat2(r2),@#tcolor1
patt1	=	.+2
	movb pat1(r2),@#tcolor2
.endc
...
.if ne VIDEO
	mov	@#patt2,r2
    mov @#patt1,@#patt2
	mov	r2,@#patt1	; switch patterns
	mov	@#patt2a,r2
    mov @#patt1a,@#patt2a
	mov	r2,@#patt1a	; switch patterns
.endc
	sub	@#dya,r5		; update b
...
dya:	.word	dy
mxa:	.word	mx
pat1:   .byte 0, 136., 128., 8., 132., 204., 192., 12.
pat2:   .byte 0, 68.,   4, 4, 68., 204., 192., 12.
